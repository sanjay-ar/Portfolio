...
export const experiences: Experience[] = [
  {
    ...
    location: "Bengaluru",
    summary:
      "I build backend workflows and engineering automation around the AppDynamics Controller, connecting dependable services with faster, clearer developer feedback.",
    highlights: [
      "Developing Java and Python workflows across Controller services, REST integrations, and SQL-backed operations.",
      "Building an MCP engineering assistant to bring contextual guidance closer to day-to-day development.",
      "Strengthening E2E automation, validation, and CI feedback for safer delivery.",
    ],
    workflow: [
      "Controller workflow",
    ...
    technologies: ["Java", "Python", "REST APIs", "SQL", "MCP", "CI/CD"],
    current: true,
  },
  {
    id: "naatscorp",
