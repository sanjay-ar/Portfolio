      ...
      <div className="mx-auto flex w-[90%] flex-col items-center justify-center lg:max-w-[1212.8px]">
        ...
        <div className="mx-auto flex w-[100%] flex-col lg:max-w-[1200px] lg:flex-row lg:gap-20">
          <div className="mb-10 flex w-[100%] flex-col gap-4 text-[18px] font-medium  leading-relaxed tracking-wide text-[#e4ded7] md:mb-16 md:gap-6 md:text-[20px] md:leading-relaxed lg:mb-16  lg:max-w-[90%] lg:text-[24px] ">
            ...
            <AnimatedBody
              text={
"In addition to my work in software development, I am also an active leader and participant in tech communities on campus. I have won several inter-college hackathons and regularly participate in various tech events."              }
            />
            <AnimatedBody
              text={
                "Whether it's playing badminton, cheering on Manchester United, hanging out with friends, or discovering new hobbies, I'm always looking for ways to relax and unwind. Additionally, I enjoy hiking, trying out new recipes in the kitchen, and attending local art exhibitions."
              }
            />
            <AnimatedBody
              text={
